...
const WhatIsDevfest = () => {
  return (
    <div
      ...
      style={{ background: useColorModeValue("#202124", "#ffffff") }}
    >
      <div className={styles.headingWrapper}>
        <div className={styles.heading}>
          <div className={styles.cloudContainer}>
            <Cloud3
              color={useColorModeValue("#ffffff", "#202124")}
              className={styles.cloud3}
            />
          </div>
          <div
            className={styles.headText}
            style={{ color: useColorModeValue("#ffffff", "#202124") }}
          >
            What is DevFest ?
          </div>
        </div>
      ...
      <div className={styles.bottomContainer}>
        <Bottom2 color={useColorModeValue("#E8EAED", "#202124")} />
        <Bottom3
          color={useColorModeValue("#E8EAED", "#202124")}
